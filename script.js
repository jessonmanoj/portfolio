...
const CONFIG = {
  ...
  projects: [
    ...
    { title: 'Turbo C IDE', description: 'A browser-based Turbo C-style coding environment with 10 built-in C programs and a practice workspace that validates and runs user code.', tech: ['React', 'JavaScript', 'Interactive'], categories: ['javascript', 'web'], icon: 'TC', color: 'linear-gradient(135deg,#0000a8,#5555cc)', liveUrl: 'turbo-c-ide.html?v=2' }
  ]
};
